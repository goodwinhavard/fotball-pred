...
def split_matches(all_matches, team_idx):
    """Split matches into played and unplayed, filtering unplayed to known teams."""
...
def simulate_season(played_df, unplayed_df, model, n_sims):
    """
    Run n_sims Monte Carlo simulations of the remaining season.
